/*
 * @Author: liuhanchuan 
 * @Date: 2022-11-24 18:34:37 
 * @Last Modified by: mikey.zhaopeng
 * @Last Modified time: 2022-11-29 09:29:23
 * 分时图
 */

import * as d3 from "d3";
import dataObj from './data'
function drawTimeShareChart(container, data, config = {}) {
    config = {
        marginLeft: 50,
        marginRight: 50,
        marginTop: 50,
        ...
        totalCount: 241,
        xTicks: ["9:30", "11:30/13:00", "15:00"], // 绘制x轴坐标
    }
    data = dataObj
    ...
    const theLastPoint = (item) => {
      ...
      .attr("cx", xScale(item.label)- 2)
      .attr("cy", yScale(item.now) + 2)
      .attr("r", 4)
      .attr("stroke-width", 2)
      .attr("stroke", "#fff")
      .attr("fill", "#178CEA")
      .attr("opacity", 0)
      .transition()
      .delay(config.delay == 0 ? 0 : config.duration)
...
export default drawTimeShareChart